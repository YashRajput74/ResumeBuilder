        ...
        return (
            <div className="languages" style={style?.language?.box}>
                ...
                <ul style={style?.language?.wholeList}>
                    {data.language.map((language, index) => <li key={index} style={style?.language?.listItem}>{language}</li>)}
                </ul>
            </div>
        )
    }
        ...
        return (
            <div className="languages" style={style?.language?.box}>
                ...
                <div className="individualLanguage" style={style?.language?.everylanguageBox}>
                    {data.language.map((language, index) => <div key={index} style={style?.language?.eachLanguageBox}>{language}</div>)}
                </div>
            </div>
        );
    }
